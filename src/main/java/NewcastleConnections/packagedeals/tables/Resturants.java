...
public class Resturants extends TableImpl<ResturantsRecord> {
    ...
    private static final long serialVersionUID = 1159544290;
     ...
     */
    public final TableField<ResturantsRecord, String> CONTACT = createField("contact", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>PackageDeals.Resturants.email</code>.
     */
    public final TableField<ResturantsRecord, String> EMAIL = createField("email", org.jooq.impl.SQLDataType.CLOB, this, "");
     ...
     */
    public final TableField<ResturantsRecord, Byte> PUBLICALLYVISIBLE = createField("publicallyVisible", org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "");
