...
public class TransportRecord extends UpdatableRecordImpl<TransportRecord> implements Record9<Integer, String, Double, Byte, String, Double, Double, Double, Double> {

    private static final long serialVersionUID = 1851006681;
     ...
     */
    @Override
    public Row9<Integer, String, Double, Byte, String, Double, Double, Double, Double> fieldsRow() {
     ...
     */
    @Override
    public Row9<Integer, String, Double, Byte, String, Double, Double, Double, Double> valuesRow() {
     ...
     */
    @Override
    public TransportRecord values(Integer value1, String value2, Double value3, Byte value4, String value5, Double value6, Double value7, Double value8, Double value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TransportRecord(Integer id, String name, Double ticketprice, Byte return_, String description, Double destinationlongitude, Double destinationlattitude, Double startlongitude, Double startlattitude) {
        super(Transport.TRANSPORT);
