...
<main>
    ...
    <div id="selector">
        <div class="row" style="width:100%">
            <div class="col-md-2"><label>Invoice Number</label></div>
        ...
        <div class="row" style="width:100%">
            <div class="col-md-2"><label>0001</label></div>
            <div class="col-md-2"><label>01/01/01</label></div>
            <div class="col-md-2"><label>$1.00</label></div>
            <div class="col-md-2"><label>Complete</label></div>
        </div>
        <s:iterator value="invoices" var="invoice">
            <div class="row" style="width:100%">
                ...
                <div class="col-md-2"><label>${invoice.status}</label></div>
            </div>
        </s:iterator>
    </div>
</main>
