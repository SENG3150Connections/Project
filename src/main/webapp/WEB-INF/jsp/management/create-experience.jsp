<%--
create-experience.jsp
Author: Harry Barden

Description:
    This JSP displays the creation page for a new experience package.
...
<div class="create-offer">
    <form action="/submitOffer">
        <div class="title">
            <label class="prev-dir">Manage Products/</label><label class="current-dir"> Add Experience</label>
